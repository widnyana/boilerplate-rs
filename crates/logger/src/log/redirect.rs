...
/// Starts redirecting all logs from the `log` crate
/// `slog_global::borrow_global()`.
///
/// Logs will be always outputted to the active global logger at the time of
/// logging (instead of the global logger when this function is called).
///
